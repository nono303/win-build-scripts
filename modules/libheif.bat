...
-DFFMPEG_avutil_LIBRARY=%PATH_FFMPEG%\lib\avutil.lib ^
-DFFMPEG_avutil_INCLUDE_DIR=%PATH_FFMPEG%\include ^
-DFFMPEG_avcodec_LIBRARY=%PATH_FFMPEG%\lib\avcodec.lib ^
-DFFMPEG_avcodec_INCLUDE_DIR=%PATH_FFMPEG%\include ^
