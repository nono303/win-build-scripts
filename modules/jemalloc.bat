...
MSBuild.exe msvc\jemalloc_vc2017.sln /p:OutputPath=%PATH_BUILD%\%1\ /p:OutDir=%PATH_BUILD%\%1\ /p:Turbo=true /m:%NUMBER_OF_PROCESSORS% /p:CL_MPCount=%NUMBER_OF_PROCESSORS% /t:Clean,jemalloc /p:Configuration=Release /p:DebugSymbols=false /p:DebugType=None /p:Plateform="%ARCH%" /nowarn:C4244 /nowarn:C4028
