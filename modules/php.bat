...
sed -i 's/\$Revision\$/b:%PECLMEMCACHEGITBRANCH% v:%PECLMEMCACHEVERSION%%PECLMEMCACHEPATCHVERSION% c:%PECLMEMCACHEGITCOMMIT% d:%PECLMEMCACHEGITDATE%/g' %CYGPATH_SRC%/pecl-memcache/%PECLMEMCACHECYGSRCDIR%/memcache.c
