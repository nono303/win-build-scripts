...
echo.
call gradlew --configuration-cache --project-cache-dir %PATH_GRADLE_BUILD% -q dependencyInsight --dependency garmin:fit --single-path --configuration runtimeClasspath | head -1
echo.
