...
echo.
call gradlew --project-cache-dir %PATH_GRADLE_BUILD% -q dependencyInsight --dependency org.geotools:gt-main --single-path --configuration runtimeClasspath | head -1
echo.
