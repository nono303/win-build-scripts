...
# LINK FLAGS (dll exe)
sed -i -E 's/command = "link"/command = "link" \/NOLOGO \/LTCG \/OPT:REF,ICF \/CGTHREADS:8/g' $2/build.ninja

# LINK FLAGS (lib)
sed -i -E 's/command = "lib"/command = "lib" \/NOLOGO \/LTCG \/CGTHREADS:8/g' $2/build.ninja
