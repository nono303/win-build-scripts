...
echo.
call gradlew --project-cache-dir %PATH_GRADLE_BUILD% -q mobac:dependencyInsight --dependency org.mapsforge:mapsforge-core --single-path --configuration runtimeClasspath | head -1
echo.
