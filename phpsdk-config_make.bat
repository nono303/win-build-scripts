...
REM export config options
	call configure --help > C:\httpd-sdk\_logs\configure_%PHPGITVER:~4,-1%.txt
...
if %PHPVER% == 7.4 (
	REM *** DISABLED zmq & mysql-xdevapi --with-zmq=shared --enable-mysql-xdevapi=shared --with-boost=C:\src\boost --with-protobuf=..\depsnono\
