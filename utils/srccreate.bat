...
cd /D cares
git checkout tags/v1.34.3
cd /D ..
git clone https://github.com/curl/curl.git curl
cd /D curl
git checkout tags/curl-8_11_0
cd /D ..
...
cd /D icu
git checkout tags/release-76-1
cd /D ..
