...
cd /D icu
git checkout tags/release-77-rc
cd /D ..
...
cd /D ..
git clone https://github.com/nono303/mod_zstd mod_zstd
cd /D mod_zstd
git checkout main
cd /D ..
...
cd /D openssl-quic
git checkout tags/openssl-3.3.0-quic1
cd /D ..
...
cd /D php-src
git checkout tags/php-8.4.5RC1
cd /D ..
