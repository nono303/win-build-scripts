...
cd /D mobac
git checkout apacheCommonsHttp
cd /D ..
...
cd /D openssl
git checkout tags/openssl-3.6.0
cd /D ..
...
cd /D php-sdk
git checkout tags/php-sdk-2.6.0
cd /D ..
