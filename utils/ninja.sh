...
sed -i -E 's/LINK_FLAGS =(.*)\/machine:(...)(.*)\/debug(.*)/LINK_FLAGS =\1\/machine:\2 \/DEBUG\3\/NOLOGO \/LTCG \/OPT:REF,ICF \/CGTHREADS:8\4/gI' $2/build.ninja
# LINK FLAGS (lib)
...
# opti
sed -i 's/ \/O2 \/Ob1/ \/Gw \/Gy \/Zc:inline \/O2 \/Ob3 \/Zf \/Zi \/FS \/GL \/MP'$3' \/cgthreads8 '$avx' \/w/gI' $2/build.ninja
# search	/O2 /Ob1
# found		/DWIN32 /D_WINDOWS /W4 /MD /Zi /ZF /O2 /Ob1 /DNDEBUG
# result	/DWIN32 /D_WINDOWS /w /MD /Gw /Gy /Zc:inline /O2 /Ob3 /Zf /Zi /FS /GL /MD /MP16 /cgthreads8 /arch:AVX /DNDEBUG
# remove default std
