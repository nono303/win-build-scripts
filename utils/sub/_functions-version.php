<?php
	...
	*/
	...
	const OUT_RELEASE = ["verpatch", "sslh", "libconfig", "nssm", "sdlna", "run-hidden", "proxytunnel", "memcached", "dependencies", "mapsforgesrv", "mobac", "fit2gpx", "subversion", "serf", "php-sdk", "geographiclib"];
