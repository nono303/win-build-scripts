...
if exist %2\. (
	...
	set BININFO_LOG=%PATH_LOGS%\%1_%MSVC_DEPS%-%ARCH%%AVXB%_%ymdhis%.csv
	call do_php %PATH_UTILS%\sub\%1.php %PATH_INSTALL%\bin %BININFO_LOG:\=/% %2 %3 nb:245 %4 %5 %6 %7
	call do_php %PATH_UTILS%\sub\%1.php %PATH_INSTALL%\bin\iconv %BININFO_LOG:\=/% %2 %3 nb:426 %4 %5 %6 %7
	call do_php %PATH_UTILS%\sub\%1.php %PATH_INSTALL%\modules %BININFO_LOG:\=/% %2 %3 nb:256 %4 %5 %6 %7
