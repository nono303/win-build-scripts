...
C:\cyg64\bin\bash /cygdrive/c/httpd-sdk/modules_bat/httpd_flags_%CMAKE_BUILD_TYPE%.sh
C:\cyg64\bin\bash /cygdrive/c/httpd-sdk/modules_bat/httpd_flags.sh %CYGV%
...
Copy /Y C:\httpd-sdk\install\bin\libcurl.pdb D:\github\NONO_mod_md\%MSVC_DEPS%\%ARCH%%AVXB%\libcurl.pdb
Copy /Y C:\httpd-sdk\install\bin\libcurl.dll D:\github\NONO_mod_md\%MSVC_DEPS%\%ARCH%%AVXB%\libcurl.so
