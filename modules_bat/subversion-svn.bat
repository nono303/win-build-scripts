...
python gen-make.py --release -t vcproj --with-jdk=C:\jdk8\%ARCH% --with-serf=C:\httpd-sdk\install\include --with-sqlite=C:\httpd-sdk\src\sqlite-amalgamation --vsnet-version=2017 --with-openssl=C:\httpd-sdk\install --with-apr-util=C:\httpd-sdk\install --with-apr=C:\httpd-sdk\install --with-apr-iconv=C:\httpd-sdk\install --with-zlib=C:\httpd-sdk\install --with-apr_memcache=C:\httpd-sdk\install --with-httpd=C:\httpd-sdk\install 
	REM ;__ALL_TESTS__ 
C:\cyg64\bin\bash /cygdrive/c/httpd-sdk/modules_bat/subversion-svn.sh
if %MSVC_DEPS% == vc15 (C:\cyg64\bin\bash /cygdrive/c/httpd-sdk/modules_bat/vcxproj2vc15.sh "subversion/build/win32/vcnet-vcproj")
C:\cyg64\bin\bash /cygdrive/c/httpd-sdk/vcxproj.sh "/cygdrive/c/httpd-sdk/src/subversion/build/win32/vcnet-vcproj/" %AVXVCX%
...
Copy /Y C:\httpd-sdk\install\bin\libssl-1_1%sslarch%.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libssl-1_1%sslarch%.dll
Copy /Y C:\httpd-sdk\install\bin\libcrypto-1_1%sslarch%.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libcrypto-1_1%sslarch%.dll
...
Copy /Y C:\httpd-sdk\install\bin\libexpat.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libexpat.dll
...
Copy /Y C:\httpd-sdk\install\bin\brotlienc.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%brotlienc.dll
Copy /Y C:\httpd-sdk\install\bin\brotlicommon.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%brotlicommon.dll
Copy /Y C:\httpd-sdk\install\bin\brotlidec.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%brotlidec.dll
Copy /Y C:\httpd-sdk\install\bin\libserf-2.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libserf-2.dll

Copy /Y C:\httpd-sdk\install\bin\libssl-1_1%sslarch%.pdb D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libssl-1_1%sslarch%.pdb
Copy /Y C:\httpd-sdk\install\bin\libexpat.pdb D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libexpat.pdb
...
Copy /Y C:\httpd-sdk\install\bin\libcrypto-1_1%sslarch%.pdb D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libcrypto-1_1%sslarch%.pdb
Copy /Y C:\httpd-sdk\install\bin\brotlienc.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%brotlienc.pdb
Copy /Y C:\httpd-sdk\install\bin\brotlicommon.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%brotlicommon.pdb
Copy /Y C:\httpd-sdk\install\bin\brotlidec.dll D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%brotlidec.pdb
Copy /Y C:\httpd-sdk\install\bin\libserf-2.pdb D:\github\NONO_subversion\%MSVC_DEPS%\%ARCH%%AVXB%%DEPS%libserf-2.pdb
