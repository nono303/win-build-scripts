...
%PATH_BIN_CYGWIN%\bash %CYGPATH_MODULE_BAT%/libmaxminddb.sh
if %MSVC_DEPS% == vc15 (%PATH_BIN_CYGWIN%\bash %CYGPATH_MODULE_BAT%/vcxproj2vc15.sh "libmaxminddb/projects/VS12")
