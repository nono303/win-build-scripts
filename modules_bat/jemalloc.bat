...
git reset --hard
git clean -fdx
if %MSVC_DEPS% == vc15 (bash %CYGPATH_MODULE_BAT%/vcxproj2vc15.sh "jemalloc-cmake/msvc/projects/vc2015/jemalloc")
C:\cyg%CYGV%\bin\sh.exe -c "CC=cl ./autogen.sh"
bash %CYGPATH_HTTPD_SDK%/vcxproj.sh "%CYGPATH_SRC%/jemalloc-cmake/msvc/projects/vc2015/jemalloc/" %AVXVCX%
