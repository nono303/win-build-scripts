...
| ------------------------------------------------------------ | ---- | -------------- | ------------------- |
| [Visual Studio 2022 Community](https://visualstudio.microsoft.com/fr/thank-you-downloading-visual-studio/?sku=Community&rel=16) |      | 17.4.0-p6 (14.34) | `.vsconfig`         |
...
| [Meson](https://github.com/mesonbuild/meson/releases) | [python] | 0.64.0rc2 | |
