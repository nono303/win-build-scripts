...
| ------------------------------------------------------------ | ---- | -------------- | ------------------- |
| [Visual Studio 2019 Community](https://visualstudio.microsoft.com/fr/thank-you-downloading-visual-studio/?sku=Community&rel=16) |      | 16.8.4 (14.28) | `.vsconfig`         |
...
| [Python](https://www.python.org/downloads/)                  | x64  | 3.9.1150       |                     |
...
| [Git](https://git-scm.com/download/win)                      | x64  | 2.30.0.2    |                     |
