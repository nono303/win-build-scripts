...
| ------------------------------------------------------------ | ---- | -------------- | ------------------- |
| [Visual Studio 2022 Community](https://visualstudio.microsoft.com/fr/thank-you-downloading-visual-studio/?sku=Community&rel=16) |      | 17.7.0-p6 (14.37) | `.vsconfig`         |
...
| [Node.js](https://nodejs.org/en/download/current/) | x64 | 20.5.0 | |
...
| [Git](https://git-scm.com/download/win)                      | x64  | 2.41.0.3 |                     |
...
| [Gradle](https://services.gradle.org/distributions/) | [java] | 8.2.1 | |
| [CMake](https://cmake.org/download/) | x64 | 3.27.1 | |
| [Ninja](https://github.com/ninja-build/ninja/releases) | x64 | 1.11.1 | |
| [Meson](https://github.com/mesonbuild/meson/releases) | [python] | 1.2.0 | |
