...
| ------------------------------------------------------------ | ---- | -------------- | ------------------- |
| [Visual Studio 2022 Community](https://visualstudio.microsoft.com/fr/thank-you-downloading-visual-studio/?sku=Community&rel=16) |      | 17.3.0-p5 (14.33) | `.vsconfig`         |
...
| [Node.js](https://nodejs.org/en/download/current/) | x64 | 18.7.0 | |
...
| [CMake](https://cmake.org/download/) | x64 | 3.24.0 rc5 | |
