...
| ------------------------------------------------------------ | ---- | -------------- | ------------------- |
| [Visual Studio 2022 Community](https://visualstudio.microsoft.com/fr/thank-you-downloading-visual-studio/?sku=Community&rel=16) |      | 17.5.0-p1 (14.35) | `.vsconfig`         |
...
| [Node.js](https://nodejs.org/en/download/current/) | x64 | 19.2.0 | |
| [OpenJDK](https://jdk.java.net/19/)                     | x64  | 19.0.1 |                     |
| [Strawberry Perl](https://strawberryperl.com/releases.html) | x64  | 5.32.1.1 |                     |
| [NASM](https://www.nasm.us/pub/nasm/releasebuilds/?C=M;O=D) | x64  | 2.16rc10 |                     |
...
| [Gradle](https://gradle.org/install/) | [java] | 7.6.0 | |
| [CMake](https://cmake.org/download/) | x64 | 3.25.1 | |
| [Ninja](https://github.com/ninja-build/ninja/releases) | x64 | 1.11.1 | |
| [Meson](https://github.com/mesonbuild/meson/releases) | [python] | 0.64.1 | |
