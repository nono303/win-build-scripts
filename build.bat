...
cmake -Wno-dev -G "NMake Makefiles" -DCMAKE_INSTALL_PREFIX=C:\httpd-sdk\install -DCMAKE_BUILD_TYPE=%CMAKE_BUILD_TYPE% -DAPR_HAS_LDAP=ON -DAPR_BUILD_TESTAPR=OFF -DAPU_HAVE_ODBC=ON -DINSTALL_PDB=OFF -DAPU_HAVE_CRYPTO=ON -DOPENSSL_ROOT_DIR=C:\httpd-sdk\install\ ..\..\src\apr-util
nmake /B /NOLOGO clean install
